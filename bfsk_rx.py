...
class bfsk_recv(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "bfsk_recv")
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/niels/hiero3', False)
...
def main(top_block_cls=bfsk_recv, options=None):
